...
vim.keymap.set("n", "<leader>r", function() harpoon:list():remove() end, { desc = "[R]emove all "})

vim.keymap.set("n", "<leader>h", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = "Open [H]arpoon quick menu"})
